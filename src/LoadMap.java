...
public final class LoadMap {
    ...
    public void loadMap(World world, Integer mapNumber){
        ...
        if (!maps.containsKey(mapNumber)){
            ...
            gameObjects.add(new DynamicSquare(world, new Vec2(1f, 2f), 0.8f, 100f, 0f, Color.BLUE, 0.4d, 0.4d));
            gameObjects.add(new DynamicSquare(world, new Vec2(1.5f, 2f), 0.8f, 100f, 0f, Color.AQUA, 0.4d, 0.4d));
            gameObjects.add(new DynamicSquare(world, new Vec2(1.3f, 0.5f), 0.8f, 100f, 0f, Color.AZURE, 0.4d, 0.4d));
            gameObjects.add( new Square(world, new Vec2(0f, 3f), 100f, Color.BEIGE, 0.4d, 6d));
            gameObjects.add( new Square(world, new Vec2(7f, 3f), 100f, Color.BEIGE, 0.4d, 6d));

            Square bottomSquare = new Square(world, new Vec2(0f, 5.5f), 100f, Color.AZURE, 8d, 0.4d);
